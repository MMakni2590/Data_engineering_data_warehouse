...
# ANALYTICAL QUERIES
most_played_songs = ("""SELECT sp.song_id, COUNT(*) as play_count, s.title
...
highest_usage_time_of_day = ("""SELECT EXTRACT(HOUR FROM start_time) AS hour, COUNT(*) as play_count
FROM songplays
GROUP BY hour
ORDER BY play_count DESC
LIMIT 5;""")
...
analytical_queries = [most_played_songs, highest_usage_time_of_day]